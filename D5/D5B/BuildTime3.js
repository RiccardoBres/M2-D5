...
//Funzione che permette di controllare attraverso un loop se la ricerca si allinea con i profili. 
 ...
 function jobSearcher(location, position) {
  ...
  for(let i = 0; i < jobs.length; i++) {
    ...
    if (jobs[i].title.includes(position) && jobs[i].location.includes(location)) {
      result.push({
